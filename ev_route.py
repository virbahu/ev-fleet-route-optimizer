...
def optimize_ev_fleet_route(params):
    n = len(params["items"])
...
if __name__=="__main__":
    items = [{{"name": "S1", "cost": 0.12, "capacity": 200}},
             {{"name": "S2", "cost": 0.15, "capacity": 150}},
             {{"name": "S3", "cost": 0.08, "capacity": 250}}]
    print(optimize_ev_fleet_route({{"items": items, "demand": 500}}))
